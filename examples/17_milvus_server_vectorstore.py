...
def example_milvus_server_vectorstore():
    ...
    try:
        ...
        # Add segments
        segments = [
            TextSegment(content="Quantum computing uses qubits.", segment_id="qc_1", metadata={"topic": "science"}),
            TextSegment(content="AI agents can automate complex workflows.", segment_id="ai_1", metadata={"topic": "tech"}),
            TextSegment(content="The Mediterranean diet is healthy.", segment_id="food_1", metadata={"topic": "health"})
        ]
        ...
        print(f"Example failed (Make sure your Milvus server is running at http://localhost:19530): {e}")

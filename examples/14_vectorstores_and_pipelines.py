...
def example_in_memory_rag_pipeline():
    ...
    try:
        ...
        segments = [
            TextSegment(
                content="Maticlib is built in Python and supports OpenAI and Gemini.",
                segment_id="1",
            ),
            TextSegment(
                content="The RAG pipeline natively supports Hybrid Retrieval.",
                segment_id="2",
            ),
            TextSegment(
                content="MaticGraph is the stateful workflow engine behind Maticlib.",
                segment_id="3",
            ),
        ]

...
class MistralResponse(LLMResponseBase):
    ...
    Attributes:
        id (str): Unique identifier for the Mistral response.
        created (int): Unix timestamp of creation.
        object (str): Object type (e.g., 'chat.completion').
        choices (List[MistralChoice]): List of completion choices.
        timestamp (datetime): Convert Unix timestamp to datetime object.
    """

...
class DummyEmbeddings:
    ...
    def embed_documents(self, texts):
        ...
        return EmbedDocumentsResponse(vectors=[[0.1, 0.2, 0.3] for _ in texts], prompt_tokens=len(texts))
...
def test_in_memory_index():
    ...
    seg1 = TextSegment(content="Hello world", segment_id="1", metadata={"type": "greeting"})
    seg2 = TextSegment(content="Goodbye world", segment_id="2", metadata={"type": "farewell"})

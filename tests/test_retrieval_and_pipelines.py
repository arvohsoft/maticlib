...
def test_rrf_ranker():
    ...
    list1 = [TextSegment(content="A", segment_id="1"), TextSegment(content="B", segment_id="2")]
    list2 = [TextSegment(content="C", segment_id="3"), TextSegment(content="A", segment_id="1")]
...
def test_query_transformer():
    class DummyLLM:
        def complete(self, prompt): return "Query var 1\nQuery var 2"
        def get_text_response(self, res): return res
